...
describe("POST /addgame", () => {
    it("returns 200 for valid game creation", async () => {
        let body7 = {
            name: "teste",
        ...
        let game = {
            name: "jogo-teste",
            email: "https://s2.glbimg.com/sySdqgJjqYAuz3exN3vqKmOVMbE=/0x0:731x493/984x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_08fbf48bc0524877943fe86e43087e7a/internal_photos/bs/2019/3/j/hUGy7XTgaQOaBpBrfeKQ/captura-de-tela-2019-03-07-as-23.11.05.png",
            price: 1,
            description: "testing a test game!" 
        }

        const addGame = await supertest(app).post("/addgame")
        .set("authorization", `Bearer ${token}`).send(game);
        expect(addGame.status).toEqual(200);
    });
    it("returns 401 for unauthorized requests", async () => {
        ...
        const addGameBad = await supertest(app).post("/addgame")
        .set("authorization", null).send();
        expect(addGameBad.status).toEqual(401);
    });
